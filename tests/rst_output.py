...
basic_rst = [
    ...
    ".. role:: gherkin-rule-keyword\n",
    ".. role:: gherkin-rule-content\n",
...
no_scenarios_rst = [
    ...
    ".. role:: gherkin-tag-content\n",
    "\n",
    ":gherkin-feature-keyword:`Feature:` :gherkin-feature-content:`Something`\n",
    "========================================================================\n\n",
]
rules_rst = [
    ".. role:: gherkin-step-keyword\n",
    ...
    "| :gherkin-step-keyword:`Given` that this file exists\n",
    "\n",
    ":gherkin-scenario-keyword:`Scenario:` :gherkin-scenario-content:`Test a Scenario without rule`\n",
    "----------------------------------------------------------------------------------------------\n\n",
    ".. pull-quote::\n\n",
    "    :gherkin-tag-keyword:`Tagged:` quarantined, JIRA-1234\n\n",
    "    :gherkin-scenario-description:`A scenario is quicker to write than a outline but less robust.`\n",
    ...
    "| :gherkin-step-keyword:`Then` the file is converted into rST\n",
    "\n",
    ":gherkin-rule-keyword:`Rule:` :gherkin-rule-content:`Test rule with two scenarios`\n",
    "----------------------------------------------------------------------------------\n\n",
    ":gherkin-scenario-outline-keyword:`Scenario Outline:` "
    ":gherkin-scenario-outline-content:`Test a Scenario Outline inside a rule`\n",
    "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n",
    "    :gherkin-scenario-description:`A scenario outline helps you avoid confusing duplication.`\n",
    "| :gherkin-step-keyword:`Given` I put **\\<thing\\>** in a blender\n",
    "| :gherkin-step-keyword:`When` I turn the blender on\n",
    ...
    '    “banana“, “smoothie“\n',
    "\n",
    ":gherkin-scenario-keyword:`Scenario:` :gherkin-scenario-content:`Multiple scenario in a rule`\n",
    "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n",
    "    :gherkin-scenario-description:`Test a second scenarion inside the same rules`\n",
    "| :gherkin-step-keyword:`Given` another state\n",
    "| :gherkin-step-keyword:`Then` the file is converted into rST\n",
    "\n",
    ":gherkin-rule-keyword:`Rule:` :gherkin-rule-content:`Test rule with one scenario`\n",
    "---------------------------------------------------------------------------------\n"
    "\n",
    ":gherkin-scenario-keyword:`Scenario:` :gherkin-scenario-content:`Normal scenarios with add on steps (And, But)`\n",
    "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n",
